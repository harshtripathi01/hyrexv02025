    ...
    return (
        <div className='px-[195px] w-full'>
            ...
            <div className='flex flex-col justify-center items-center mt-[74px]'>
                ...
                <p className='font-bold text-[40px] text-[#3C23B5]'>How HyrEx helps your business? </p>
            </div>
            <div className='flex justify-evenly items-center'>
                ...
                <div className='h-[310px] max-w-[633px] w-full flex justify-start'>
                    <ul className='list-disc'>
                        <li className='text-[#212832] font-bold text-[25px]'>High-quality insights:<span className='text-[#212832] font-normal text-[25px]'> Use our RAG based GenAI, OBKA, to get quick on-demand insights from highly vetted experts
                        </span></li>
