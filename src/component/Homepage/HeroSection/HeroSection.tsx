...
const HeroSection = () => {
    ...
    return (
        <div className='w-full h-auto' style={heroStyle}>
            ...
            <div>
                <div className='flex flex-col gap-3 px-20 pt-40'>
                    <div>
                ...
                <div className='flex flex-col gap-0 px-20 pt-[160px]'>
                    ...
                    <button className='py-1 text-[#3C23B5] rounded-[10px] max-w-[134px] max-h-[45px] w-full h-full font-bold'>Request a demo</button>
                    </div>
                </div>
            ...
            <div className='px-[195px] mt-96 w-full'>
                <div className='flex flex-col justify-center items-center mt-[74px]'>
                    <p className='font-bold text-[12px] text-[#637381]'>FOR INDUSTRY PROFESSIONALS</p>
                    <p className='font-bold text-[40px] text-[#3C23B5] text-center max-w-[678px] w-full'>How HyrEx helps your professional growth? </p>
                </div>
                <div className='flex justify-center items-center w-full'>
                    <div className='h-[217px] flex justify-end max-w-[551px] w-full'>
                        <ul className='list-disc'>
                            <li className='text-[#212832] font-bold text-[25px]'>Monetize knowledge: <span className='text-[#212832] font-normal text-[25px]'>Top professionals could make $5K+ every month through HyrEx, through content direct sales and royalties
                            </span></li>
                            ...
                            <li className='text-[#212832] font-bold text-[25px]'>Quality content: <span className='text-[#212832] font-normal text-[25px]'>Connect with like professionals only - avoid all the social media noise and make professional connections meaningful
                            </span></li>
                        </ul>
                    </div>
